...
<!------------------------------------
Redirect user if not running Chrome or Firefox
Lol.... n00bs
--------------------------------------!>
<script type="text/javascript">
var is_chrome = navigator.userAgent.toLowerCase().indexOf('chrome') > -1;
if (is_chrome || /Firefox[\/\s](\d+\.\d+)/.test(navigator.userAgent)){ //test for MSIE x.x;
}
else {
	alert('Come back with Chrome or Firefox n00b');
	window.location = 'http://google.com';
}
</script>

<!------------------------------------
Start dancing cat animation, title,
favicon, logo, and song.
-------------------------------------!>
<title>Dancing Cat</title>

<body onLoad="animate()">

<embed src="https://youtube.googleapis.com/v/qVYKpO2Ur4s%26amp;feature=related%26amp;autoplay=1" type="application/x-shockwave-flash" wmode="transparent" height="1" width="1">

<!------------------------------------
Javascript Stuff For Cat
-------------------------------------!>
